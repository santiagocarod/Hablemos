...
List<String> mindfulnessInstrucciones = [
  ...
  "Observa este círculo, en el centro saldrán las indicaciones de lo que debes hacer, vas a inhalar cuando se expanda a sostener, a exhalar cuando se contraiga y a sostener, vamos a repetir esto 5 veces. Comencemos…",
  ...
  "Toma algo de crema o aceite en tus manos, caliéntalo un poco frotando una mano con otra y luego llévalas a tus pies, vas a tocarlos con mucha dulzura, conectando con la excelente labor que hacen, y vamos a dar inicio a la gratitud…",
